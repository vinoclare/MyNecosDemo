...
public class DynamicRoutingConfig implements ApplicationEventPublisherAware {
    ...
    private static final String DATA_ID = "zuul-dev.json";
    ...
    public void refreshRouting() throws NacosException {
        ...
        properties.put(PropertyKeyConst.SERVER_ADDR, "127.0.0.1:8848");     // 端口配置
        //properties.put(PropertyKeyConst.NAMESPACE, "8282c713-da90-486a-8438-2a5a212ef44f");   // namespace配置
        ConfigService configService = NacosFactory.createConfigService(properties);  // 创建ConfigService
        configService.addListener(DATA_ID, Group, new Listener() {   // 添加监听
            @Override
            ...
            @Override
            public void receiveConfigInfo(String configInfo) {   // 接收监听到的配置信息
